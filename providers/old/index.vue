    ...
    <div class="row">
      <div class="col-12 col-md-3 col-lg-3">
        <div class="_1card _padd20 _mar_b15 _b_radious7 _5box_shadow one _0border">
          ...
          <p class="price_card_price">sdfsdfsdf</p>
        </div>
      </div>
                  ...
                  <tr v-for="(item,index) in filteredItems" :key="index">
                    ...
                    <td>
                      <button
                        ...
                        @click="customModalOn(item,index)"
                      >See Details</button>
                    </td>
                    ...
                    <td v-if="item.schedule">{{item.schedule.scheduleName}}</td>
                    <td>{{item.status}}</td>
                    <td>
                      <button
                        class="_btn _btn_outline_success _btn_sm"
                        @click="completedOrder(item,index)"
                      >Complete</button>
                    </td>
                  </tr>
                </tbody>
...
export default {
  ...
  methods: {
    ...
    //   (this.customModal = true), (this.customorder = item.customorder);
    // },
